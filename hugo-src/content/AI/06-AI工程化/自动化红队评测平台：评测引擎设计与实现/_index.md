...
menu: 
  main: 
    parent: "AI实战"
aliases:
  - "/AI/09-实战项目架构/自动化红队评测平台评测引擎设计与实现/"
---

## 平台需求分析

在 [大模型红队测试](../../08-安全与AI融合/大模型红队测试：方法论、自动化工具与评测基准/) 中我们建立了攻击向量体系和安全评测基准，在 [评测平台架构](../../03-Agent架构与框架生态/评测平台架构：自动化评测、Trace回放与归因分析/) 中我们掌握了评测工程化的基础框架。然而，当红队测试的规模从手动验证扩展到数百个攻击向量、数十个模型版本、多个安全维度的并行评测时，一个专为红队场景设计的**自动化评测平台**就成为刚需。
...
基于 [LLM-as-Judge 原理](../../03-Agent架构与框架生态/LLM-as-Judge：原理、偏差分析与实战配置/)，我们设计了分层评判机制：
...
- [评测平台架构：自动化评测、Trace 回放与归因分析](../../03-Agent架构与框架生态/评测平台架构：自动化评测、Trace回放与归因分析/) — 通用评测平台的架构设计模式
- [LLM-as-Judge：原理、偏差分析与实战配置](../../03-Agent架构与框架生态/LLM-as-Judge：原理、偏差分析与实战配置/) — 自动化评判的技术原理与工程实践
- [Agent 评测方法论：维度设计、指标体系与评测框架](../../03-Agent架构与框架生态/Agent评测方法论：维度设计、指标体系与评测框架/) — 评测维度设计与指标体系构建
