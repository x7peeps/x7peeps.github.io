...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217220720.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217223209.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217221419.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224141938.png)
...
> 笔者一次base64之后结果如下：
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217224343.png)
...
```
> 笔者Gzip解码后结果如下：
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217231326.png)
...
```
> 笔者payload解码:
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191217234720.png)
...
```
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218002128.png)

> 插一句，这里执行的时候其实是触发了火绒，但是Windows Defender并未触发，火绒放行即可：
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218001642.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218004810.png)
...
Out c:\payload.ps1
```
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218005231.png)

替换掉原来的被解压的payload如下所示看起来这样：
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218013101.png)

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218012146.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191218014707.png)

重点：你需要从invoke-Obfuscation输出的内容中剔除 ```|```，因为它是命令执行的指令。我们不需要它因为Cobalt Strike模板会处理这个。

> 原文的图片实在是太模糊了，吐

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224172756.png)

> 本地测试按照提示进行替换，并保存为.ps1文件，放入靶机测试
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224173003.png)
> 经测试，发现目前此方式由于非base64导致报错，导致脚本无法执行成功
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224172550.png)


保存编辑的脚本到powershell文件并执行。当Cobalt Strike中的beacon点亮，并出现提示@sec_groundzero Aggressor 脚本的注意之后成功。

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224173157.png)


如果我们同时检查原始 CS payload和修改过的 CS payload，通过Process Hacker我们看到我们并不会改变beacon的行为。

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/系统入侵对抗研究/CS X86 payload分析混淆加密/20191224173222.png)
