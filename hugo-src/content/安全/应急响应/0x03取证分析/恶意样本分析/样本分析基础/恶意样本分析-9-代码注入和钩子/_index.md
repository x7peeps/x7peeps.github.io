...
![image-20220315150240415](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315150240415.png)
...
![image-20220315150424203](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315150424203.png)
...
![image-20220315150536840](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315150536840.png)
...
![image-20220315150622660](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315150622660.png)
...
![image-20220315151133264](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315151133264.png)
...
![image-20220315152100588](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152100588.png)
...
![image-20220315152143994](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152143994.png)
...
![image-20220315152623852](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152623852.png)
...
![image-20220315152814116](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152814116.png)
...
![image-20220315152845835](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152845835.png)
...
![image-20220315152923870](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315152923870.png)
...
![image-20220315153033729](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315153033729.png)
...
![image-20220315154355968](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154355968.png)
...
![image-20220315154421038](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154421038.png)

下面的截图显示了Internet Explorer进程内存中的地址0x2270000的内容（这是作为第3个参数传递给QueueUserAPC()的；这个地址包含了之前被恶意软件写入的DLL的完整路径。

![image-20220315154438749](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154438749.png)
...
![image-20220315154543053](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154543053.png)
...
![image-20220315154602781](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154602781.png)
...
![image-20220315154659098](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154659098.png)
...
![image-20220315154750075](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315154750075.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16636556500682.jpg)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16636655929578.jpg)

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637259035959.jpg)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637259376068.jpg)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637229112466.jpg)


![image-20220315160318646](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160318646.png)

在下面的对话框中，输入你要调整的应用程序的细节。程序的名称和供应商名称可以是任何东西，但程序文件的位置应该是正确的。
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637230017947.jpg)


![image-20220315160347475](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160347475.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637302646350.jpg)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16645063284306.jpg)


![image-20220315160414180](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160414180.png)

接下来，你将看到一个屏幕，指定哪些属性将被程序（notepad）匹配。当notepad.exe运行时，所选的属性将被匹配，在匹配条件得到满足后，将应用垫片。为了使匹配条件不那么严格，我取消了所有的选项，在这里显示。

![image-20220315160459029](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220315160459029.png)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637303290311.jpg)


在你点击 "完成 "后，一个完整的应用程序和应用的修复的摘要将呈现在你面前，如下所示。在这一点上，包含notepad.exe的shim信息的shim数据库被创建。

![image-20220315160520910](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160520910.png)

![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637303544723.jpg)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637306347355.jpg)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637306547045.jpg)

![image-20220315160544677](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160544677.png)
...
```
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16637307142801.jpg)


![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16645156213008.jpg)
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16645156857003.jpg)

现在，如果你调用notepad.exe，abcd.dll将从c:\test目录加载到notepad的进程地址空间，如图所示。

![image-20220315160616632](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160616632.png)
...
![image-20220315160941503](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315160941503.png)

第二个注册表，HKLM\SOFTWARE\Microsoft\WindowsNT\CurrentVersion\AppCompatFlags\InstalledSDB\，包含数据库信息和shim数据库文件的安装路径。

![image-20220315161110845](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220315161110845.png)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/16645416939279.jpg)
...
![image-20220316131721168](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316131721168.png)
...
![image-20220316131802305](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316131802305.png)
...
![image-20220316131943872](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220316131943872.png)
...
![image-20220316132005791](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132005791.png)
...
![image-20220316132105688](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132105688.png)
...
![image-20220316132131425](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220316132131425.png)



5. 然后，它使用WriteProcessMemory()将恶意的可执行文件及其部分复制到新分配的内存地址0x00400000。

![image-20220316132158382](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220316132158382.png)
...
![image-20220316132218861](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220316132218861.png)
...
![image-20220316132232334](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132232334.png)
...
![image-20220316132644172](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132644172.png)
...
![image-20220316132708353](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132708353.png)
...
![image-20220316132931997](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132931997.png)
...
![image-20220316132957963](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316132957963.png)
...
![image-20220316133013049](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133013049.png)

在注入可执行文件后，HttpSendRequestA()被钩住，将程序控制重定向到注入的可执行文件中的一个恶意函数。在我们看这个被钩住的函数之前，让我们看一下合法的HttpSendRequestA()函数的前几个字节（如图所示）。

![image-20220316133031813](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133031813.png)
...
![image-20220316133055543](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133055543.png)
...
![image-20220316133719819](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133719819.png)
...
![image-20220316133808140](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133808140.png)
...
![image-20220316133851767](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133851767.png)
...
![image-20220316133930430](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133930430.png)
...
![image-20220316133955081](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316133955081.png)

检查LoadLibraryW()函数可以看到该函数开始时的跳转指令，该指令最终将把程序控制权转给shellcode。

![image-20220316134019109](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-9-代码注入和钩子/image-20220316134019109.png)
