...
![image-20220114020703095](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220114020703095.png)
...
![image-20220114021116411](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220114021116411.png)
...
![image-20220114021715693](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220114021715693.png)
...
![image-20220305175735169](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305175735169-6474259.png)
...
![image-20220305193256666](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305193256666.png)
...
![image-20220305193029754](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305193029754.png)

符号窗口。 你可以点击符号标签来显示符号窗口的内容。左边窗格显示加载的模块（可执行文件及其DLLs）的列表；点击一个模块条目将在右边窗格中显示其导入和导出函数，如下所示。这个窗口对于确定导入和导出函数在内存中的位置非常有用。



![image-20220305193010372](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305193010372.png)
...
![image-20220305192100811](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305192100811.png)

线程窗口Threads Window。这显示了当前进程中的线程列表。你可以在这个窗口上点击右键，暂停一个/多个线程或恢复一个暂停的线程。

![image-20220305193357066](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220305193357066.png)
...
![image-20220306104257783](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220306104257783.png)
...
![image-20220306184837797](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220306184837797.png)

在创建可执行文件后，恶意软件将CreateFile返回的句柄值（0x54）作为第一个参数传递给WriteFile，并写入可执行内容（作为第二个参数传递），如这里所示。

![image-20220306223949571](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220306223949571.png)
...
![image-20220306224008340](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220306224008340.png)
...
![image-20220307093421813](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307093421813.png)

![image-20220307100228703](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307100228703.png)
...
![image-20220307101718678](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307101718678.png)
...
![image-20220307133912405](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307133912405.png)
...
![image-20220307134337584](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307134337584.png)
...
![image-20220307134630811](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307134630811.png)
...
![image-20220307134714421](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307134714421.png)
...
![image-20220307134919783](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307134919783.png)
...
![image-20220307135422200](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307135422200.png)
...
![image-20220307135911771](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307135911771.png)

##### 2.9.1 指令追踪 

要对前一个程序进行指令追踪（例如，追踪到），可以在追踪到对话框中使用以下设置。如前所述，为了在日志文件中捕获跟踪事件，你需要指定日志文件的完整路径和日志文本。

![image-20220307135745405](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307135745405.png)
...
![image-20220307140522818](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307140522818.png)

为了进行函数追踪（本例中选择了Trace into），采用了以下设置。这类似于指令跟踪，除了在日志条件字段中，指定一个表达式，告诉调试器只记录函数调用。

![image-20220307140627072](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307140627072.png)
...
![image-20220307140449099](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307140449099.png)
...
![image-20220307140805891](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307140805891.png)

在你修改了内存或指令中的数据后，你可以通过选择文件|补丁文件将补丁应用到文件中，这时会出现一个补丁对话框，显示对二进制文件的所有修改。一旦你对所做的修改感到满意，点击补丁文件并保存该文件。

![image-20220307140830510](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307140830510.png)
...
![image-20220307141019962](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307141019962.png)

![image-20220307141236897](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307141236897.png)
...
![image-20220307151857703](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307151857703.png)
...
![image-20220307152020379](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/static/images/recovered/image-20220307152020379.png)
...
![image-20220307153214197](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307153214197.png)
...
![image-20220307164114035](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307164114035.png)
...
![image-20220307164216226](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307164216226.png)
...
![image-20220307164506421](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307164506421.png)
...
![image-20220307164538011](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307164538011.png)
...
![image-20220307170609128](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307170609128.png)
...
![image-20220307170641913](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307170641913.png)
...
![image-20220307170839584](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307170839584.png)
...
![image-20220307171007508](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307171007508.png)
...
![image-20220307171132792](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307171132792.png)

 下面的截图显示了跟踪窗口中的指令跟踪事件，当时调试器在第五条指令处暂停。注意执行过程是如何从main流向sub_E41000，然后又回到main的。如果你想跟踪其余的指令，你可以通过恢复暂停的进程来实现。

![image-20220307171243890](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307171243890.png)
...
![image-20220307171332910](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307171332910.png)

在下面的例子中，恶意软件样本调用了两个函数。 假设我们想快速了解第一个函数调用了哪些其他函数。

![image-20220307171436564](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220307171436564.png)
...
![image-20220308131848665](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220308131848665.png)

一旦二进制文件被反编译，你可以阅读代码（静态代码分析），以确定恶意软件的功能，或调试代码并执行动态代码分析。要调试恶意软件，你可以点击工具栏上的 "开始 "按钮，或选择 "调试"|"调试汇编"（F5）；这将弹出如图所示的对话框。

![image-20220308131923714](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220308131923714.png)
...
![image-20220308131952555](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析基础/恶意样本分析-7-调试恶意软件二进制文件/image-20220308131952555-6716794.png)
