...
date: 2019-11-23T21:29:00+08:00
tags: 恶意样本分析,实例
menu: 
  main: 
    parent: "样本分析记录"
...
rtf
文件md5信息
ee9f79e2dd1d0cc6134facdd4c9b9ec6
文件sha1信息
4eb319d14fe441bb2604d4f92e646d1f258ebfc2
文件sha256信息
aac73d7cd77c0abb532db7cd70c1679bdbaca30c82386a67a504dd1299c8aa66
文件ssdeep信息
96:c3KlZARvYj1HJcuL2hoykm7QvdfOguQy0DKteo:WKlOvYtBHmElOguQRKV
文件magic信息
...
FileAccessDate:2019:09:02 14:49:26+08:00
FileInodeChangeDate:2019:09:02 14:49:26+08:00
FileModifyDate:2019:09:02 14:49:26+08:00
FileSize:102 kB
FileType:RTF
...
![](20190903171034.png-A)
![](20190903171043.png-A)
当文件点击后台调用绑定splwow64.exe加载程序执行shellcode 并发起回链请求
![](20190903171058.png-A)
![](20190903171108.png-A)
回链请求如下所示：
![](20190903171119-20210929092339175.png-A)
回链请求地址为：
...
RTF/Obfuscation
![](20190903171403.png-A)
![](20190903171421.png-A)
http://evaglobal.eu/donstanz/donstanzo.exe
与动态分析结果一致。


IOCs:
evaglobal.[eu]/donstanz/donstanzo.exe
tfvn.com.[vn]/cytr/ja/QC87vPYWw7RCO6k.exe
tfvn.com.[vn] 
evaglobal.[eu]
47.88.102.244

对比IOCs:发现符合AZORult家族恶意软件系列回链地址，因此判断此次攻击为针对国内的邮件攻击服务。
![](20190903171557.png-A)
