...
date: 2019-10-13T20:29:00+08:00
tags: 恶意样本分析,实例
menu: 
  main: 
    parent: "样本分析记录"
...
![1567047275649](1567047275649.png-A)

![1567047252995](1567047252995-20210929092525724.png-A)

![1567047290833](1567047290833.png-A)
...
![img](clip_image004.jpg-A)

 

通过还原发现其，向外发送形如下的邮件回传信息。

![img](clip_image006.jpg-A)

可以看到样本执行后对外发送大量邮件传递信息，或恶意邮件传播。

![img](clip_image008-20210929092540534.jpg-A)

![img](clip_image010.jpg-A)

通过分析其邮件内容发现在对外发起的各类伪造邮件中发现大量进行对外蠕虫类攻击行为。

 ![img](clip_image014.jpg-A)

不到半小时发邮件50多条，发送附件110多条。在对发件内容分析过程中发现，样本在执行之后会将受感染主机作为发件人，并通过布置邮件服务对外发起欺骗类恶意传播邮件和垃圾邮件。

针对恶意样本的批量检测：

![img](clip_image016.jpg-A)

![img](clip_image018.jpg-A)
