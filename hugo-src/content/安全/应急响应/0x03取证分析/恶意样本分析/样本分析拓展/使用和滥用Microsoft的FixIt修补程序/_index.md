...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676452516103.jpg)
...
3893的修复补丁的部分输出。 
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676685765054.jpg)
                        图3-t选项的输出。 
             
“-d”命令打印sdb文件中的所有匹配项。该命令将生成所有目标模块的列表、它们的版本号以及相关的校验和。 
             
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676686070186.jpg)
               图4--D选项的输出 
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676686622658.jpg)
                 
图5-s选项的输出 
上面的图5使用了’-s’选项，显示了从IE 6匹配中打印列表中第一个校验和的补丁细节时的输出。输出显示存储在补丁中的二进制blob和解码内容。解码内容的含义与本文补丁分析部分讨论的含义相同。 
             
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676686995467.jpg)
                 图6-补丁和校验和标记 
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676687327489.jpg)
                 图7-IDAPython脚本 
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676688487533.jpg)
...
![](https://raw.githubusercontent.com/x7peeps/x7peeps-images/main/content/安全/应急响应/0x03取证分析/恶意样本分析/样本分析拓展/使用和滥用Microsoft的FixIt修补程序/16676688823278.jpg)
             图9-explorer.exe主补丁后
