...
<div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center; margin-top: 30px; margin-bottom: 30px;">
  <img src="/images/products/offlinepassbook/screenshot1.jpg" alt="界面预览 1" style="max-width: 300px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
  <img src="/images/products/offlinepassbook/screenshot2.jpg" alt="界面预览 2" style="max-width: 300px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
</div>
